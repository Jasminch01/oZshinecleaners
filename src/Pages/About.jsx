  ...
  return (
    <div>
      <div className="bg-slate-800 min-h-screen py-16">
        <div className="pt-28 text-white text-center w-[90%] lg:w-full">
          ...
          <p className="mb-5 text-gray-300 text-sm lg:text-lg font-medium font-Roboto leading-loose  px-10 w-[70%] mx-auto ">
              ...
              >
                <div className="grid md:grid-cols-4 grid-cols-1 gap-20  ">
                  ...
                  >
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/128/9957/9957478.png" className="w-24" alt="" />
                  ...
                  >
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/128/9957/9957478.png" className="w-24" alt="" />
                      ...
                      <p className="text-xs leading-loose mt-3  text-gray-400 text-center">
                        ...
                        cleaning solutions Melbourne are the answer. We don't
      ...
      <h2 className="text-3xl font-bold text-primary-c text-center mb-5 " >Why Do You Need Our Services?</h2>
      <p className=" text-gray-300 text-sm lg:text-lg font-medium font-Roboto leading-loose  px-10 w-[70%] mx-auto text-center mb-10">Our Melbourne residential cleaning services guarantee a meticulous approach, emphasising quality in every aspect of our service. Choose us for a cleaner, healthier, and more vibrant home. We don't just clean; we transform spaces into havens of hygiene.
</p>
      <Swipers></Swipers>
      </div>
    </div>
